...
For the VR Rendering of 3D object i have used https://glitch.com/,  which takes input as glb and usdz file format and provide htttp link which is converted into bar code.
...
To run the project type npm install then npm start to run the localhost.
